...
**Android 12 update breaks the functioning of the apps** - a fix is expected to come from the apps' developers. Keeo in mind AAAD is just an installation utility and has no responsibility on their functioning (see [FAQs](https://github.com/shmykelsa/AAAD/#i-have-a-problem-with-an-app-installed-by-aaad-could-you-help-me-out)). **Temporary solution: clear cache and data of Android Auto before using it, or downgrade to Android Auto [6.9.613744](https://www.apkmirror.com/apk/google-inc/android-auto/android-auto-6-9-6137-release/android-auto-6-9-613744-release-android-apk-download/). [Here](https://github.com/shmykelsa/AAAD/wiki/How-to-downgrade-Android-Auto) instructions on how to do this.**
